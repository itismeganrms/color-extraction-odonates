...
run = wandb.init(
    ...
    tags=["Mask2Former", "annotated-images", "4-part-annotated","merged-dataset"],
    config={
...
def setup(args):
    ...
    cfg = get_cfg()
    cfg.DATASETS.TRAIN = (f"dragonfly_merged_train",)
    cfg.DATASETS.TEST = (f"dragonfly_merged_valid",)
