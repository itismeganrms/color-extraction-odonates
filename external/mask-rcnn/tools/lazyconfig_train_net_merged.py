...
def register_custom_coco_dataset(args) -> None:
   ...
   if args.eval_only:
    ...
    register_coco_instances(
        f"dragonfly_merged_valid",
        {},
        os.path.join(annotations_path, "instances_valid.json"),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default="/home/mrajaraman/dataset/dataset-v2-coco/", help="Path to the dataset directory containing annotations and images")
